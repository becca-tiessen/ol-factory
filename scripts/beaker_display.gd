...
const INGREDIENT_COLORS: Dictionary = {
	...
	"Rose Oil": Color("E8A0BF"),
	"Jasmine Oil": Color("F2DC5D"),
	"Cedar Oil": Color("A0522D"),
	"Sandalwood Oil": Color("D2A679"),
	"Vanilla Oil": Color("F5E6CA"),
	"Bergamot Oil": Color("F0C05A"),
	"Peppermint Oil": Color("7EC8A0"),
}
